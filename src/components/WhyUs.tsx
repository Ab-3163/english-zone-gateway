...
const WhyUs = () => {
  ...
  const reasons = [
    { icon: Users, title: t("whyUs.reasons.teachers.title"), description: t("whyUs.reasons.teachers.desc"), color: "from-blue-500 to-blue-600" },
    { icon: BookOpen, title: t("whyUs.reasons.modern.title"), description: t("whyUs.reasons.modern.desc"), color: "from-green-500 to-green-600" },
    { icon: Trophy, title: t("whyUs.reasons.results.title"), description: t("whyUs.reasons.results.desc"), color: "from-yellow-500 to-orange-500" },
    { icon: Building2, title: t("whyUs.reasons.env.title"), description: t("whyUs.reasons.env.desc"), color: "from-purple-500 to-purple-600" },
  ];
  return (
      ...
      <div className="container mx-auto relative z-10">
        ...
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-4">
            ...
            <span className="text-primary font-semibold">{t("whyUs.badge")}</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
            {t("whyUs.title")} <span className="text-gradient">ÉLITE ZONE</span>؟
          </h2>
